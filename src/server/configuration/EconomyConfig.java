...
public enum EconomyConfig {
	...
	FIRSTPRISE("sethome.firstprice"),
	NEXTPRISE("sethome.nextprice"),
	LIMIT("sethome.limit"),
	SUBMIT("sethome.submit"),
	TYPE("sethome.priseType"),
	CALNEL("sethome.calnel"),
	NOMONEY("sethome.nomoney"),;
     ...
     */
    EconomyConfig(Object value, boolean fixedValue) {
        if (fixedValue) {
            this.node = "";
    ...
    public static void clearCache() {
        for (EconomyConfig configNode : EconomyConfig.values()) {
