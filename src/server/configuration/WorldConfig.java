...
public enum WorldConfig {
	...
	MuliSpawn("spawn.multispawn"),
	Coldown("crystal.teleport-coldown");
     ...
     */
    WorldConfig(Object value, boolean fixedValue) {
        if (fixedValue) {
            this.node = "";
    ...
    public static void clearCache() {
        for (WorldConfig configNode : WorldConfig.values()) {
